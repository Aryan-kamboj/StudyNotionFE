...
export const InputField = ({type,label,placeholder,required,value,setterFn,name,max}) => {
  ...
  return (
    <div className='w-[100%]'>
        ...
        {textArea?<textarea rows={7} value={value} required={required} type={type} placeholder={placeholder} onChange={changeHandler} className={css}/>
